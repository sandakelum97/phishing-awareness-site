...
const allQuizData = {
    ...
    social: {
        ...
        questions: [
            ...
            { difficulty: 'hard', type: 'mcq', text: "An attacker compromises a legitimate vendor's email account and uses it to send a fake invoice to your company. This is called:", answers: [{text:"A Business Email Compromise (BEC) attack", correct:true}, {text:"A man-in-the-middle attack", correct:false}, {text:"Standard procedure", correct:false}, {text:"A denial-of-service attack", correct:false}], explanation: "BEC attacks are highly sophisticated because they come from a trusted, legitimate source. Always verify changes to payment details over the phone." },
...
const quizController = {
    ...
    generateLogEntry() {
        ...
        const values = [
            ...
            `"${this.quizData.title}"`, this.score, this.currentQuizSet.length, this.attempts
        ].join(',');
        return `${headers}\n${values}`;
    },
    downloadLog(logData) {
